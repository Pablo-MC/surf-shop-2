...
const Navbar = () => {
   ...
   return (
      <nav className="navbar navbar-expand-md navbar-light bg-dark py-0">
         <Link to="/">
            <img src={require('../../assets/images/logo/logo_blue.png')} width="100" alt="Main Logo" />
         </Link>
         <button className="navbar-toggler" data-toggle="collapse" data-target=".navbar-collapse">
            <span className="navbar-toggler-icon"></span>
         </button>
         <div className="collapse navbar-collapse navbar-not-flash" data-toggle="collapse" data-target=".navbar-collapse">
            <div className="navbar-nav text-uppercase ml-2">
               <Link to="/" className="nav-link active d-none d-md-block">Home</Link>
